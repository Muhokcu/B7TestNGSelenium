...
public class WebTable {
    ...
    public void printTable() {
        //driver.get("https://www.techlistic.com/p/demo-selenium-practice.html"); // bu  satiri burdan alip yukari before ye koyduk
        //driver.findElement(By.id("ez-accept-all")).click();// bu  satiri burdan alip yukari before ye koyduk
        WebElement tableDemo = driver.findElement(By.xpath("//table[@border='1']"));

        System.out.println("tableDemo.getText() = " + tableDemo.getText());
//        WebElement demoTable2 = driver.findElement(By.xpath("//h3[text()='Demo Table 2']"));// bu  satiri burdan alip yukari before ye koyduk
//        JavascriptExecutor jse = (JavascriptExecutor)driver;// bu bu  satiri burdan alip yukari before ye koyduk
//        jse.executeScript("arguments[0].scrollIntoView(true);", demoTable2);// bu  satiri burdan alip yukari before ye koyduk
